        ...
        <div>
            <el-card class="box-card">
                ...
                <el-table border :data="lists" style="width: 100%" @sort-change="sortChange" highlight-current-row @selection-change="handleSelectionChange">
                    ...
                    <el-table-column prop="username" label="点赞人" width="180">
                ...
                <div class="e-pages" style="margin-top: 10px; text-align: center">
                    <el-pagination @current-change="loadList" :current-page="search.page" :page-size="search.pagesize" @size-change="sizeChange" layout="total, sizes, prev, pager, next, jumper" :total="totalCount"> </el-pagination>
                </div>
            </el-card>
        </div>
    </div>
...
<script setup>
    ...
    const deleteItems = (ids) => {
        ElMessageBox.confirm("确定删除？", "提示", {
            ...
            http.post("/api/dianzan/delete", ids).then((res) => {
    ...
    const loadList = (page) => {
        ...
        http.post("/api/dianzan/selectTianjiaren", search).then(
            (res) => {
                loading.value = false;
                if (res.code == 0) {
                    var data = res.data;
