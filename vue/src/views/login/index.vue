                ...
                <el-col :md="8" :offset="1">
                    ...
                    <form action="javascript:;" id="loginForm" name="loginForm" method="post" @submit="login">
                        ...
                        <div class="form-group mb-4" style="display: flex; align-items: center">
                            <el-input type="text" style="width: 120px; margin-right: 15px" v-model="form.pagerandom" name="pagerandom" class="form-control form-control-lg" id="pagerandom" placeholder="验证码"> </el-input>
                            <img :src="captchUrl" style="width: 100px; height: 30px" @click="loadCaptch" alt="点击刷新" />
                        </div>
                        <div class="form-group mb-4">
                        ...
                        <div class="text-center">版权所有：{{ config.title }}</div>
                    </form>
                </el-col>
            </el-row>
        </e-container>
