<template>
    <div class="views-guanzhu-web-add">
        <div>
            <e-container>
...
<script setup>
    ...
    import { useGuanzhuCreateForm, canGuanzhuInsert } from "@/module";
    ...
    const { form, readMap } = useGuanzhuCreateForm(props.id);
