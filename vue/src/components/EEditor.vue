...
<script setup>
    ...
    const props = defineProps({
        ...
        toolbar: {
            type: [String, Array],
            default: "codesample bold italic underline alignleft aligncenter alignright alignjustify | undo redo | formatselect | fontselect | fontsizeselect | forecolor backcolor | bullist numlist outdent indent | lists link table code | removeformat | image media pageembed",
        }, //必填
    });
    //用于接收外部传递进来的富文本
