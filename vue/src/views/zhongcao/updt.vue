...
<script setup>
    ...
    import { useZhongcaoFindById, canZhongcaoFindById, canZhongcaoUpdate, canBijiFindById } from "@/module";
    ...
    const form = useZhongcaoFindById(props.id);
