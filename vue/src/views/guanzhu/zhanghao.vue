                    ...
                    <el-table-column label="操作" fixed="right" width="250">
                        <template #default="{ row }">
                            <el-button-group>
                                ...
                                <el-tooltip effect="dark" content="移除" placement="top-start"><el-button type="danger" :icon="Delete" size="small" @click="deleteItems(row.id)">移除</el-button> </el-tooltip>
                            </el-button-group>
                        </template>
                    </el-table-column>
                </el-table>
...
<script setup>
    ...
    const loadList = (page) => {
        ...
        http.post("/api/guanzhu/selectZhanghao", search).then(
            (res) => {
                loading.value = false;
                if (res.code == 0) {
                    var data = res.data;
