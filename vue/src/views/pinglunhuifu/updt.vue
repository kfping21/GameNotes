<template>
    <div class="views-pinglunhuifu-updt">
        <div>
...
<script setup>
    ...
    import { usePinglunhuifuFindById, canPinglunhuifuFindById, canPinglunhuifuUpdate, canPinglunFindById } from "@/module";
    ...
    const form = usePinglunhuifuFindById(props.id);
    ...
    const submit = () => {
        formModel.value.validate().then((res) => {
            ...
            loading.value = true;
            canPinglunhuifuUpdate(form).then(
                (res) => {
                    loading.value = false;
                    if (res.code == 0) {
