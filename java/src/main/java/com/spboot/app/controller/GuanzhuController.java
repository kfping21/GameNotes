...
public class GuanzhuController {
    ...
    @ApiOperation(value = "获取全部关注", httpMethod = "GET")
    ...
    public R selectTianjiaren(@RequestBody Map<String, Object> req) {
        return guanzhuService.selectPagesTianjiaren(req);
    }

    @ApiOperation(value = "根据条件筛选获取关注人字段值为当前用户列表并分页", httpMethod = "POST")
    @RequestMapping("/selectGuanzhuren")
    public R selectGuanzhuren(@RequestBody Map<String, Object> req) {
        return guanzhuService.selectPagesGuanzhuren(req);
    }
    ...
    public R insert(@RequestBody Map data) {
        Guanzhu post = BeanUtil.mapToBean(data, Guanzhu.class, true);
        return guanzhuService.insert(post, data);
    }

    @ApiOperation(value = "根据id列表删除数据", httpMethod = "POST")
    @RequestMapping("/delete")
    @ApiImplicitParam(name = "id", value = "关注对应的id", type = "json", dataTypeClass = List.class)
    public R delete(@RequestBody List<Integer> id) {
        return guanzhuService.delete(id);
    }
}
