<template>
    <div class="views-zhongcao-detail">
        <div>
            <el-card class="box-card">
                <template #header>
                    <div class="clearfix">
                        <span class="title"> 种草详情 </span>
                    </div>
                </template>
                ...
                <div id="printdetail">
                    <el-descriptions class="margin-top" :column="3" border>
                        ...
                        <el-descriptions-item label="种草人"> {{ map.zhongcaoren }} </el-descriptions-item>
...
<script setup>
    ...
    import { useZhongcaoFindById, canZhongcaoFindById } from "@/module";
     ...
     * @type {EZhongcao}
     */
    const map = useZhongcaoFindById(props.id);
    watch(
        () => props.id,
        (id) => {
