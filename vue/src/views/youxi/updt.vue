                ...
                <el-form :model="form" ref="formModel" :label-width="labelWidth" status-icon validate-on-rule-change>
                    <el-form-item
                        ...
                        :rules="[
                            ...
                            { validator: rule.checkRemote, message: '内容重复了', checktype: 'update', module: 'youxi', col: 'youximingcheng', id: form.id, trigger: 'blur' },
                        ]"
                    >
...
<script setup>
    ...
    import { useYouxiFindById, canYouxiFindById, canYouxiUpdate } from "@/module";
    ...
    const form = useYouxiFindById(props.id);
